...
boton_compresor1_chiller1= machine.Pin(22,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor2_chiller1= machine.Pin(19,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor3_chiller1= machine.Pin(18,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor2_chiller2= machine.Pin(19,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor3_chiller2= machine.Pin(18,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_motor_bomba1_chiller= machine.Pin(17,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_motor_bomba2_chiller= machine.Pin(14,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
...
while (continuar1):                              #  <<<< bucle while principal >>>>
    ...
    while (continuar2):                          #  <<<< bucle while de trabajo >>>>
        ...
        dato_tarjeta='tarjeta1'                     #       <<<==========   nombre de la tarjeta desde donde se envian los datos  CHILLER #1
        compresor1_chiller1=int(boton_compresor1_chiller1.value())            # sensa el estado del pin 23
        compresor2_chiller1=int(boton_compresor2_chiller1.value())            # sensa el estado del pin 23
        compresor3_chiller1=int(boton_compresor3_chiller1.value())            # sensa el estado del pin 39
        compresor2_chiller2=int(boton_compresor2_chiller2.value())            # sensa el estado del pin 23
        compresor3_chiller2=int(boton_compresor3_chiller2.value())            # sensa el estado del pin 39
        motor_bomba1_chiller=int(boton_motor_bomba1_chiller.value())            # sensa el estado del pin 22
        motor_bomba2_chiller=int(boton_motor_bomba2_chiller.value())            # sensa el estado del pin 23
        motor_bomba3_chiller=int(boton_motor_bomba3_chiller.value())            # sensa el estado del pin 39
        motor_uma40ton=int(boton_motor_uma40ton.value())                      # sensa el estado del pin 34
        
        print("compresor1_chiller1= "+str(compresor1_chiller1))
        print("compresor2_chiller1= "+str(compresor2_chiller1))
        print("compresor3_chiller1= "+str(compresor3_chiller1))
        print("compresor2_chiller2= "+str(compresor2_chiller2))
        print("compresor3_chiller2= "+str(compresor3_chiller2))
        print("motor_bomba1_chiller= "+str(motor_bomba1_chiller))
        print("motor_bomba2_chiller= "+str(motor_bomba2_chiller))
        print("motor_bomba3_chiller= "+str(motor_bomba3_chiller))
        print("motor_uma40ton= "+str(motor_uma40ton))
        #########################################################################################################################
