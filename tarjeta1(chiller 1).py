...
boton_compresor2_chiller1= machine.Pin(18,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor3_chiller1= machine.Pin(17,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
...
while (continuar1):                              #  <<<< bucle while principal >>>>
    ...
    while (continuar2):                          #  <<<< bucle while de trabajo >>>>
        ...
        compresor1_chiller1=int(boton_compresor1_chiller1.value())            # sensa el estado del pin 22
        ...
        #print("flujo_chiller1= "+str(flujo_chiller1))
        #########################################################################################################################
        ...
        for rom in roms:
            ...
            #print("id=",idhex)
            temperatura_chiller1=ds.read_temp(rom)
            print("temperatura="+str(temperatura_chiller1))
