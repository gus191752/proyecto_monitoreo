...
boton_compresor2_chiller2= machine.Pin(22,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
boton_compresor3_chiller2= machine.Pin(21,machine.Pin.IN,machine.Pin.PULL_UP)         # entrada de señales por PULL-UP
...
while (continuar1):                              #  <<<< bucle while principal >>>>
    ...
    while (continuar2):                          #  <<<< bucle while de trabajo >>>>
        ...
        dato_tarjeta='tarjeta2'                     #       <<<==========   nombre de la tarjeta desde donde se envian los datos  CHILLER #2    
